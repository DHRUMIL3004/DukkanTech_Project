...
const featuresList = [
  ...
  },
  {
    ...
    description: "Track your products easily. Add, update, and organize items.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "Register employees and control their access to the system.",
  },
  {
    id: 5,
    icon: <Shield size={30} />,
    title: "Secure System",
    description: "Your business data is protected with secure access control.",
  },
  {
    id: 6,
    icon: <ShoppingBag size={30} />,
    title: "Customer Records",
    description: "Maintain customer information and purchase history.",
  },
];
